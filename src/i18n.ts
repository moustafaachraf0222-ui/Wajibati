...
export const copy: Record<Language, Record<string, string>> = {
  ar: {
    ...
    absenceGridHint: 'ضع علامة أمام التلميذ الغائب. يمكنك تغيير القسم وتكرار العملية قبل إرسال التقرير.',
    absent: 'غائب',
    present: 'حاضر',
    ...
    supervisorAbsenceFlowHint: 'اختر تاريخ الغياب والحصة الجاهزة، ثم اختر السنة والشعبة والقسم واحفظ غيابات كل قسم قبل إرسال التقرير النهائي.',
    ...
    sessionNotAssignedToClass: 'هذه الحصة غير مرتبطة بالقسم المختار.',
  ...
  fr: {
    ...
    absenceGridHint: 'Cochez l’élève absent. Vous pouvez changer de classe et répéter avant d’envoyer le rapport.',
    absent: 'Absent',
    present: 'Présent',
    ...
    supervisorAbsenceFlowHint: 'Choisissez la date et la séance préparée, puis l’année, la filière et la classe. Enregistrez chaque classe avant d’envoyer le rapport final.',
    ...
    sessionNotAssignedToClass: 'Cette séance n’est pas liée à la classe choisie.',
  ...
  en: {
    ...
    absenceGridHint: 'Check the absent student. You can switch classes and repeat before sending the report.',
    absent: 'Absent',
    present: 'Present',
    absentCount: 'Absences',
    ...
    supervisorAbsenceFlowHint: 'Choose the absence date and prepared session, then the year, stream, and class. Save each class before sending the final report.',
    ...
    sessionNotAssignedToClass: 'This session is not assigned to the selected class.',
