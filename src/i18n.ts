...
export const copy: Record<Language, Record<string, string>> = {
  ar: {
    ...
    timeFormatRequired: 'املأ خانتي الساعة والدقيقة بصيغة 08:00 وتأكد أن وقت النهاية بعد وقت البداية.',
    ...
    supervisorAbsenceFlowHint: 'اختر تاريخ الغياب والحصة أو الحصص الجاهزة، ثم اختر السنة والشعبة والقسم واحفظ غيابات كل قسم قبل إرسال التقرير النهائي.',
  ...
  fr: {
    ...
    timeFormatRequired: 'Remplissez les champs heure et minute au format 08:00 et vérifiez que la fin est après le début.',
    ...
    supervisorAbsenceFlowHint: 'Choisissez la date et une ou plusieurs séances préparées, puis l’année, la filière et la classe. Enregistrez chaque classe avant d’envoyer le rapport final.',
  ...
  en: {
    ...
    timeFormatRequired: 'Fill both hour and minute fields as 08:00, and make sure the end time is after the start time.',
    ...
    supervisorAbsenceFlowHint: 'Choose the absence date and one or more prepared sessions, then the year, stream, and class. Save each class before sending the final report.',
