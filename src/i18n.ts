...
export const copy: Record<Language, Record<string, string>> = {
  ar: {
    ...
    timeFormatRequired: 'اكتب الوقت بصيغة 08:00 وتأكد أن وقت النهاية بعد وقت البداية.',
  ...
  fr: {
    ...
    timeFormatRequired: 'Saisissez l’heure au format 08:00 et vérifiez que la fin est après le début.',
  ...
  en: {
    ...
    timeFormatRequired: 'Type the time as 08:00 and make sure the end time is after the start time.',
