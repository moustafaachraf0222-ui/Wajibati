...
export const copy: Record<Language, Record<string, string>> = {
  ar: {
    ...
    labManagementHint: 'أضف المخابر والأجهزة وحدد حالة كل فترة وجهاز.',
    labName: 'اسم المخبر',
    ...
    labStatusHint: 'حالة الفترات الصباحية والمسائية حتى يعرف الأستاذ وقت الاستعمال.',
  ...
  fr: {
    ...
    labManagementHint: 'Ajoutez les laboratoires et les appareils, puis définissez l’état de chaque période et appareil.',
    ...
    labStatusHint: 'État des périodes du matin et de l’après-midi pour que l’enseignant sache quand utiliser le laboratoire.',
  ...
  en: {
    ...
    labManagementHint: 'Add laboratories and devices, then set each period and device status.',
    ...
    labStatusHint: 'Morning and afternoon status so teachers know when a laboratory can be used.',
