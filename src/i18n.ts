...
export const copy: Record<Language, Record<string, string>> = {
  ar: {
    ...
    supervisorAbsenceFlowHint: 'اختر التاريخ والسنة والشعبة والقسم أولاً، وستظهر جداول وحصص ذلك القسم في اليوم المختار.',
  ...
  fr: {
    ...
    supervisorAbsenceFlowHint: 'Choisissez d’abord la date, l’année, la filière et la classe. Les plannings et séances de cette classe s’affichent pour le jour choisi.',
  ...
  en: {
    ...
    supervisorAbsenceFlowHint: 'Choose the date, year, stream, and class first. The matching timetable and sessions for that class will appear for the selected day.',
