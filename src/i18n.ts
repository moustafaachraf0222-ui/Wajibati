...
export const copy: Record<Language, Record<string, string>> = {
  ar: {
    ...
    supervisorAbsenceFlowHint: 'اختر تاريخ الغياب ثم قالب الحصص المرتبط بالقسم، وحدد الحصة والتلاميذ الغائبين قبل إرسال التقرير للمدير.',
    draftAbsenceCount: 'غيابات غير مرسلة',
    draftReport: 'تقرير قيد التحضير',
    chooseAbsenceTarget: 'اختر السنة ثم الشعبة ثم القسم.',
    sendAbsenceReport: 'إرسال تقرير الغيابات',
    absenceReportSent: 'تم إرسال تقرير الغيابات للمدير.',
  ...
  fr: {
    ...
    supervisorAbsenceFlowHint: 'Choisissez la date, puis le modèle lié à la classe, la séance et les élèves absents avant l’envoi.',
    ...
    sendAbsenceReport: 'Envoyer le rapport d’absences',
    absenceReportSent: 'Le rapport d’absences a été envoyé au directeur.',
  ...
  en: {
    ...
    supervisorAbsenceFlowHint: 'Choose the absence date, then the schedule template linked to the class, the session, and the absent students before sending the report.',
    ...
    sendAbsenceReport: 'Send absence report',
    absenceReportSent: 'The absence report was sent to the director.',
