...
export const copy: Record<Language, Record<string, string>> = {
  ar: {
    ...
    absenceGridHint: 'الأسماء في الأسطر والحصص في الأعمدة. ضع علامة عند غياب التلميذ.',
    absent: 'غائب',
    present: 'حاضر',
  ...
  fr: {
    ...
    absenceGridHint: 'Les élèves sont en lignes et les séances en colonnes. Cochez les absents.',
    absent: 'Absent',
    present: 'Présent',
  ...
  en: {
    ...
    absenceGridHint: 'Students are rows and sessions are columns. Check a box when the student is absent.',
    absent: 'Absent',
    present: 'Present',
    absentCount: 'Absences',
