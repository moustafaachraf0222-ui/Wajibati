...
export const copy: Record<Language, Record<string, string>> = {
  ar: {
    ...
    createStudentAccount: 'إنشاء حساب تلميذ',
    studentSignupHint: 'أدخل نطاق مدرسة مسجلة ثم أكمل بيانات التلميذ.',
    schoolDomain: 'نطاق المدرسة',
    validSchoolDomainHint: 'اكتب نطاق المدرسة المسجلة مثل salam.dz لإظهار بيانات التسجيل.',
  ...
  fr: {
    ...
    studentSignupHint: 'Saisissez le domaine d’une école enregistrée puis complétez les informations de l’élève.',
    schoolDomain: 'Domaine de l’école',
    validSchoolDomainHint: 'Saisissez un domaine enregistré comme salam.dz pour afficher les champs d’inscription.',
  ...
  en: {
    ...
    studentSignupHint: 'Enter a registered school domain, then complete the student information.',
    schoolDomain: 'School domain',
    validSchoolDomainHint: 'Enter a registered domain such as salam.dz to show the registration fields.',
