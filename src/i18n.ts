...
export const copy: Record<Language, Record<string, string>> = {
  ar: {
    ...
    bulkActivationCodeHint: 'سيتم إنشاء البريد وكود التفعيل عشوائياً لكل تلميذ، وستجدها في قاعدة بيانات التلاميذ للطباعة.',
    importStudents: 'إنشاء القائمة',
    studentListRequired: 'أدخل أسماء التلاميذ.',
    studentsImported: 'تم إنشاء حسابات التلاميذ. يمكنك طباعتها من قاعدة بيانات التلاميذ.',
    studentsImportedCount: 'عدد الحسابات المنشأة',
  ...
  fr: {
    ...
    bulkActivationCodeHint: 'L’e-mail et le code d’activation seront générés automatiquement pour chaque élève, puis disponibles dans la base des élèves pour impression.',
    importStudents: 'Créer la liste',
    studentListRequired: 'Saisissez les noms des élèves.',
    studentsImported: 'Les comptes élèves ont été créés. Vous pouvez les imprimer depuis la base des élèves.',
    studentsImportedCount: 'Comptes créés',
  ...
  en: {
    ...
    bulkActivationCodeHint: 'The email and activation code will be generated automatically for each student, then available in the student database for printing.',
    importStudents: 'Create list',
    studentListRequired: 'Enter student names.',
    studentsImported: 'Student accounts were created. You can print them from the student database.',
    studentsImportedCount: 'Created accounts',
