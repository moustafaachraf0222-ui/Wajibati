...
export const copy: Record<Language, Record<string, string>> = {
  ar: {
    ...
    supervisorAbsenceFlowHint: 'اختر تاريخ الغياب ووقت الحصة، ثم السنة والشعبة والقسم، وحدد التلاميذ الغائبين قبل إرسال التقرير للمدير.',
  ...
  fr: {
    ...
    supervisorAbsenceFlowHint: 'Choisissez la date et l’heure de séance, puis l’année, la filière et la classe, et cochez les élèves absents avant l’envoi.',
  ...
  en: {
    ...
    supervisorAbsenceFlowHint: 'Choose the absence date and session time, then the year, stream, and class, and mark absent students before sending the report.',
