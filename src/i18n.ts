...
export const copy: Record<Language, Record<string, string>> = {
  ar: {
    ...
    createOnlyTeacherStudent: 'المدير يستطيع إنشاء المراقبين والمخبريين والأساتذة والتلاميذ فقط، ولا يستطيع إنشاء مديرين آخرين.',
  ...
  fr: {
    ...
    createOnlyTeacherStudent: 'Le directeur peut créer seulement des surveillants, laborantins, enseignants et élèves, pas d’autres directeurs.',
  ...
  en: {
    ...
    createOnlyTeacherStudent: 'Directors can create only supervisors, lab technicians, teachers, and students, not other directors.',
...
export const roleNames: Record<Language, Record<Role, string>> = {
  ar: { admin: 'المشرف العام', director: 'مدير المدرسة', supervisor: 'المراقب', lab: 'المخبري', teacher: 'الأستاذ', student: 'التلميذ' },
  fr: { admin: 'Administrateur', director: 'Directeur', supervisor: 'Surveillant', lab: 'Laborantin', teacher: 'Enseignant', student: 'Élève' },
  en: { admin: 'Administrator', director: 'School director', supervisor: 'Supervisor', lab: 'Lab technician', teacher: 'Teacher', student: 'Student' }
};
