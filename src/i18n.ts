...
export const copy: Record<Language, Record<string, string>> = {
  ar: {
    ...
    studentSignupHint: 'أدخل الاسم الكامل كما هو في قائمة المدرسة، ثم نطاق المدرسة ورمز التفعيل.',
    ...
    bulkStudentImportHint: 'اختر السنة والشعبة والقسم، ثم اكتب كل اسم تلميذ في سطر منفصل.',
    studentNamesList: 'قائمة أسماء التلاميذ',
    studentNamesPlaceholder: 'مثال:\nTarek Lattoui\nMeriem Haddad\nYacine Benali',
    bulkActivationCodeHint: 'سيتم إنشاء كود تفعيل عشوائي فقط لكل تلميذ. التلميذ ينشئ البريد والحساب بنفسه عند إدخال الاسم والنطاق والكود.',
  ...
  fr: {
    ...
    studentSignupHint: 'Saisissez le nom complet comme dans la liste de l’école, puis le domaine et le code d’activation.',
    ...
    bulkStudentImportHint: 'Choisissez l’année, la filière et la classe, puis écrivez un élève par ligne.',
    studentNamesList: 'Liste des noms des élèves',
    studentNamesPlaceholder: 'Exemple :\nTarek Lattoui\nMeriem Haddad\nYacine Benali',
    bulkActivationCodeHint: 'Seul un code d’activation aléatoire sera généré pour chaque élève. L’élève crée son e-mail et son compte avec le nom, le domaine et le code.',
  ...
  en: {
    ...
    studentSignupHint: 'Enter the full name exactly as listed by the school, then the school domain and activation code.',
    ...
    bulkStudentImportHint: 'Choose the year, stream, and class, then write one student name per line.',
    studentNamesList: 'Student names list',
    studentNamesPlaceholder: 'Example:\nTarek Lattoui\nMeriem Haddad\nYacine Benali',
    bulkActivationCodeHint: 'Only a random activation code will be generated for each student. The student creates the email and account using the name, domain, and code.',
