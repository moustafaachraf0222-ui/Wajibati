...
export const copy: Record<Language, Record<string, string>> = {
  ar: {
    ...
    studentAbsenceJustificationsHint: 'اختر الغياب المطلوب ثم اكتب تبريراً أو ارفع ملفاً يثبت سبب الغياب.',
    ...
    absenceJustificationsHint: 'مبررات التلاميذ مرتبة حسب التاريخ والقسم.',
  ...
  fr: {
    ...
    studentAbsenceJustificationsHint: 'Choisissez une absence, puis écrivez une justification ou joignez un fichier.',
    ...
    absenceJustificationsHint: 'Justifications des élèves classées par date et par classe.',
  ...
  en: {
    ...
    studentAbsenceJustificationsHint: 'Choose an absence, then write a justification or attach a file.',
    ...
    absenceJustificationsHint: 'Student justifications grouped by date and class.',
